...
IrishGen dataset and the technical environment which it inhabits.
Additionally, a set of common specific errors that a user of the
dataset or a contributor to a dataset may encounter will be explored.
A careful reading of this will aid the reader who wants to use
IrishGen in their own research and study. The audience for this post
should be more familiar with the structure of the early Irish verb,
for instance, than the structure of a file format.

## Semantic Web and Linked Data

Before we begin, it would be beneficial to introduce two terms that
will be important if the reader wishes to explore the wider context
within which IrishGen sits, which are _Semantic Web_ and _Linked
Data_.  These terms are basically interchangeable and the reader will
see both elsewhere in the literature.  A very good history of the
terms can be found in "[Whatever Happened to the Semantic
...
holds the TRiG file in the Git repository.  The final element is the
title of the _item_ which holds the individual (for the item structure
of the genealogies, see Holberg, '[Towards a Relative Chronology of
the Milesian Genealogical
...
many systems will give the entire URL for what they find and the user
...
another unrelated individual, this will a Triplestore to return an
incorrect graph and thus either confuse, in the best case, or mislead,
in the worst, a user.  This comes down to the curators and their
understanding and interpretation of the source material and sometimes
curators make mistakes or misunderstand the material.  When this
occurs, the dataset can be and most likely will be amended, unlike a
book such as [Corpus Genealogiarum
Hiberniae](http://www.worldcat.org/oclc/911333553).

## Conclusion

This post intended to orient a reader who may not have experience in
file formats and the related standards that IrishGen conforms and
